        ...
        <>
            ...
            <div className="fixed right-0 top-0 h-full w-full max-w-md bg-white z-50 shadow-2xl flex flex-col animate-slide-in-right">
                ...
                <div className="flex items-center justify-between p-5 border-b border-app-border">
                    ...
                    <button onClick={() => setIsCartOpen(false)} className="p-2 rounded-xl hover:bg-app-cream transition-colors"><XIcon className="size-5" /></button>
                </div>
                ...
                {items.length > 0 && (
                    <div className="p-5 border-t border-app-border space-y-3">
                        ...
                        {deliveryFee > 0 && <p className="text-xs text-app-text-light text-center">Free delivery on orders over {currency}200!</p>}
